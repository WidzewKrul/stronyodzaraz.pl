    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-4 py-3 sm:gap-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/koszyk"
            aria-label={count > 0 ? `Koszyk, ${count} ${count === 1 ? "pozycja" : "pozycje"}` : "Koszyk"}
      ...
      {mobileOpen && (
        <>
          ...
          <nav id="mobile-nav" className="absolute inset-x-0 top-full z-40 max-h-[calc(100vh-60px)] overflow-y-auto border-t border-slate-200 bg-white shadow-xl md:hidden" aria-label="Mobilne">
